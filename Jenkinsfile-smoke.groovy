...
if (env.CHANGE_ID) {
    runSmokeTest (
        ...
        ocDeployerBuilderPath: "topological-inventory/topological-inventory-orchestrator",
        // the service-set/component for this app in e2e-deploy "templates"
        ocDeployerComponentPath: "topological-inventory/topological-inventory-orchestrator",
