...
COMPONENT_NAME="topo-orchestrator"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
IMAGE="quay.io/cloudservices/topological-inventory-orchestrator"
